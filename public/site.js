...
function createToast() {
    ...
    if (!toast) {
        ...
        toast.id = 'site-toast';
        toast.style.cssText = 'position:fixed;right:1rem;bottom:1rem;z-index:9999;padding:1rem 1.5rem;border-radius:999px;background:rgba(15,23,42,0.96);color:#fff;font-family:Arial, sans-serif;font-size:0.95rem;box-shadow:0 16px 40px rgba(0,0,0,0.25);transform:translateX(120%);transition:transform 0.25s ease;';
...
function showAccountMenu() {
    ...
    menu.style.cssText = 'position:absolute;top:100%;right:0;background:var(--navy);border:2px solid var(--white);border-radius:8px;padding:1rem;z-index:10001;min-width:150px;';
    menu.innerHTML = `
